...
router.get("/", async (req, res) => {
  ...
  await res.render("images", { images }); // renderiza y setea la pagina con lo que se le indique
});
router.get("/a", async (req, res) => {
  const images = ({ _id, title, description, imageURL, public_id } =   await image.find());
  // console.log({});
