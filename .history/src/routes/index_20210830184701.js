...
router.get("/", async(req, res) => {
  const m = ({_id: 612d1902b06a3c46ccb010a8,
    titl,
    description,
    imageURL: 'http://res.cloudinary.com/wolfmarcos/image/upload/v1630345473/dvr7prz10m9akjibkoyo.png',
    public_id: 'dvr7prz10m9akjibkoyo',
    cfecha: ' } = await images.find());
  //console.log({image.imageURL});
  console.log(m)
 await res.render("images",{ m : imageURL});
